...
//+kubebuilder:rbac:namespace=system,groups=demo.mctest.io,resources=shows,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:namespace=system,groups=demo.mctest.io,resources=shows/status,verbs=get;update;patch
//+kubebuilder:rbac:namespace=system,groups=demo.mctest.io,resources=shows/finalizers,verbs=update
